...
| `secret-actuator`            | OS Native Secret Manager Bridge                                                                                                                                                                                    | 1.1.0   |  4  | `bin:security`                     | `schemas/secret-action.schema.json`                              | `libs/actuators/secret-actuator`            |
