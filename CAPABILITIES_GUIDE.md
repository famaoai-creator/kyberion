...
| `system-actuator` | OS-level control, diagnostics, and short-lived local execution | 1.0.0 | 4 | `schemas/system-pipeline.schema.json` | `libs/actuators/system-actuator` |
