...
const DESIGN_MD_THEME_PATH = pathResolver.knowledge("public/design-patterns/media-templates/themes/design-md-imports.json");
const DESIGN_MD_SYSTEM_PATH = pathResolver.knowledge("public/design-patterns/media-templates/media-design-systems/design-md-imports.json");
