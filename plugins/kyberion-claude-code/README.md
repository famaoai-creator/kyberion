...
- v0.1: tier-guard (writes), audit (Write/Edit/Bash), SessionStart priming, MCP surface, 3 commands.
- Planned: `UserPromptSubmit` → intent capture / drift baseline; `Stop` → auto review/distill; Bash-level secure-io screening.
