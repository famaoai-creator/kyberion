...
_Note: This is currently performed by the Agent's core intelligence when an image path is provided._
...
pnpm kyberion run diagram-renderer --input "<description>"
```
...
pnpm kyberion run boilerplate-genie --prompt "Create a React component based on the visual-capture artifact /active/shared/captures/latest.png"
```
