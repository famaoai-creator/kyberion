...
| SX-07 | PARTIAL     | manifest-driven `pnpm check` と PR workflow gate を追加し、未知 scope・空集合・scope 外 `--only` を fail-closed 化、release を production evidence gate に接続。validate 全集合統合は未完。                    |
