...
| #   | 問題                                                                                                                                                                                                                                                                                                 | 証跡                                                                                                |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| C-1 | **`work_shape` という名前が2つの互換性のない語彙を持つ**。work item の 6値(組織運営 vs ソリューション開発の軸)と、`intent-coverage-matrix.json` の `direct_reply`/`mission` 等(実体は `execution_shape` の誤名 — `intent-coverage-contract.test.ts:63` が `intent.resolution.shape` と同値を assert) | `schemas/work-item.schema.json:40-56` vs `knowledge/product/governance/intent-coverage-matrix.json` |
