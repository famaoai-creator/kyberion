...
> **位置づけ**: [ENTITY_GOVERNANCE_UNIFICATION_PLAN](../../improvement-plans-2026-08/ENTITY_GOVERNANCE_UNIFICATION_PLAN_2026-08-09.ja.md) の追補。EG-11(一回性クリーンアップ)では解けない**再発する**ドリフトのため別項目とする。
