...
> **位置づけ**: [QM_ADOPTION_PLAN](./QM_ADOPTION_PLAN_2026-08-01.ja.md) QM-02(トリガ実行経路の単一化と権限非昇格)の **API は完成・配線が未完** という状態を閉じる後続計画。[LIFECYCLE_SMOOTHNESS_PLAN](../../improvement-plans-2026-08/LIFECYCLE_SMOOTHNESS_PLAN_2026-08-08.ja.md) LC-01(スケジューラ常駐化)の兄弟。
