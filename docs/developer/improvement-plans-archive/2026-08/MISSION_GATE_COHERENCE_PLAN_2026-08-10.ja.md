...
- **mission ticket dispatch → work store の実接続**(`solution_project` 実データ0件問題)— [LIFECYCLE_SMOOTHNESS_PLAN](../../improvement-plans-2026-08/LIFECYCLE_SMOOTHNESS_PLAN_2026-08-08.ja.md) の context chain 接続、および [ENTITY_GOVERNANCE_UNIFICATION_PLAN](../../improvement-plans-2026-08/ENTITY_GOVERNANCE_UNIFICATION_PLAN_2026-08-09.ja.md) の WorkItem context 執行の管轄。
