---
title: CLI SUBAGENT TEAM PLAN 2026 07 25
...
- [KD-05(サブエージェント能力ティア)](../../improvement-plans-2026-07/KIMI_CODE_ADOPTION_PLAN_2026-07-20.ja.md) — 能力宣言の語彙(DONE)。CT-01 と CT-05 はその射影。
...
- [KD-03(イベントソーシング復元)](../../improvement-plans-2026-07/KIMI_CODE_ADOPTION_PLAN_2026-07-20.ja.md) — journal。CLI チームでは参照のみ(復元要件が出たら agent-runtime へ)。
