...
4. **検証**: 既存 media-actuator テスト全緑 / `pnpm check -- --scope full --only catalogs` / tenant-override fixture を置いた状態で video css_vars に override の hex が出る unit test。
