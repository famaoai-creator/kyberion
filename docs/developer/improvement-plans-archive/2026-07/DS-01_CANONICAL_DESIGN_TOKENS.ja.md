---
title: DS 01 CANONICAL DESIGN TOKENS
...
- 完了: semantic token の CSS/Tailwind 出力、明示 light/dark selector の生成、operator-surface の raw hex/RGB 0件化、`check:ui-ux` の validate/CI/週次 pipeline 接続
- 継続課題: motion/transition token は DS-04 で扱う
