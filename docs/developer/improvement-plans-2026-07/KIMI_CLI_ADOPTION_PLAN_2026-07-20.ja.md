...
> **追補**: TypeScript 後継 [MoonshotAI/kimi-code](https://github.com/MoonshotAI/kimi-code) の分析(2026-07-20)は [KIMI_CODE_ADOPTION_PLAN_2026-07-20.ja.md](./KIMI_CODE_ADOPTION_PLAN_2026-07-20.ja.md)(KD-01〜09)を参照。本計画の KC-01〜09 は kimi-code でも同機構が存続しており妥当性が裏付けられた。
