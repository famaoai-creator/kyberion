...
| UX-0-3 | first-time-user 向け readiness 圧縮           | 1, 4, 13, 15                      | `pnpm setup:report`, `pnpm kyberion vital --format=json`, `libs/core/next-action.ts`                                                                                        | readiness 出力が noise を畳み、must / should / nice と next action が 1〜3 個に絞られる                                                                                       |
