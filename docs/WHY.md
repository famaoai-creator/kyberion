...
If any of this resonates, the [Quickstart](./QUICKSTART.md) is the next step. If you'd rather understand the architecture first, start with [`knowledge/product/architecture/organization-work-loop.md`](../knowledge/product/architecture/organization-work-loop.md).
