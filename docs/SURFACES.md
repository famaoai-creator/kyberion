...
| 入口                                  | 役割                                                                                                                                                                                                      | 備考                                                                                                                  |
| ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Slack / Telegram / Discord / iMessage | 会話・承認・通知(`runSurfaceMessageConversation` 経由)                                                                                                                                                    | Slack の3経路(会話 / 配信 / API)は [SLACK_CHANNEL_ROUTES.ja.md](./SLACK_CHANNEL_ROUTES.ja.md)。深い履歴閲覧には不向き |
