...
| `PERFORMANCE_DASHBOARD.md` | Self-declared "historical pre-manifest skill telemetry snapshot". The current runtime inventory is in `knowledge/product/orchestration/global_actuator_index.json`. | 2026-05-07 |
