...
| AR-01 | PARTIAL | 2026-07-12: アクチュエータ私製ループ全廃 + 重複エンジン一本化 + Task 3(super-nerve subprocess 廃止)+ Task 4(repair 統合、センシティブ fail-closed を全ランナーへ)。golden 緑。残: run_pipeline 本体ループの委譲のみ                                                                                                                                                                                                                                                                                       |
...
| ID    | 状態    | 残作業                                                                                                                                                                                    |
| ----- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AR-01 | PARTIAL | 残: run_pipeline 本体ループの委譲のみ(ループ全廃・subprocess 廃止・repair 統合・golden 緑は 2026-07-12 済み)                                                                              |
| AR-02 | PARTIAL | describeOps、op-discovery に input_schema 反映、未知 op の apply 既定撤廃(check:op-registry は 2026-07-11 に修復し validate/CI へ接続済み)                                                |
