...
| IP-08 | PARTIAL | 2026-07-12: 空 catch triage 台帳完成(94箇所を a32/b49/c13 に分類、計画文書末尾)。(c) 実バグ根治: tier-guard の破損ポリシー fail-open を fail-closed 化 + 沈黙 catch 4箇所へ警告付与。残: (b) logger.warn 横展開、console→logger、process.exit 除去 |
