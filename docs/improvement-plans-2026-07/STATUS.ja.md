...
| AR-01 | PARTIAL | 2026-07-11: network-actuator を正準エンジンへ移行(横展開2件目、ネスト失敗の fail-propagate 統一)。残: modeling/system/wisdom/browser の4ループ(code は traceCtx 互換ラップ込みで移行済み)、run_pipeline 委譲、golden 回帰、repair 統合                                                                                                                                                                                                                                                                    |
...
| ID    | 状態    | 残作業                                                                                                                                                                                    |
| ----- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AR-01 | PARTIAL | 残: 4アクチュエータの私製ループ移行、run_pipeline 委譲、golden 回帰、repair 統合(network は 2026-07-11 移行済み)                                                                          |
| AR-02 | PARTIAL | describeOps、op-discovery に input_schema 反映、未知 op の apply 既定撤廃(check:op-registry は 2026-07-11 に修復し validate/CI へ接続済み)                                                |
