...
| IP-08 | PARTIAL | 2026-07-12: 空 catch triage 台帳完成(94箇所を a32/b49/c13 に分類、計画文書末尾)。(c) 実バグ根治: tier-guard の破損ポリシー fail-open を fail-closed 化 + 沈黙 catch 4箇所へ警告付与。(b) 49箇所へ logger.warn 全件付与(29ファイル、制御フロー不変)。残: console→logger、process.exit 除去 |
...
| ID    | 状態    | 残作業                                                                                                                                                                                                                                 |
| ----- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| QA-01 | PARTIAL | 2026-07-12: 5 schema、10観点カタログ、DoR/AC/DoD/traceability評価、mission gate、欠陥候補/品質報告generator、CLI、pipeline fragmentを実装。残: reasoning補完、actuator別dispatch、欠陥状態機械、operator UI、6シナリオE2E、enforce運用 |
