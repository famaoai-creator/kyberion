...
These scenarios can be formalized as JSON ADF pipelines (`pipelines/*.json`) or mission playbooks (`knowledge/orchestration/mission-playbooks/`). Use `skill-bundle-packager` to package the skills for each scenario into a reusable bundle:
