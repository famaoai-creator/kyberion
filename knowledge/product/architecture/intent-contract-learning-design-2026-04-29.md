...
```json
{
  ...
  "contract_ref": {
    "kind": "schema",
    "path": "knowledge/product/schemas/points-portal-clickout-usecase.moppy-rakuten-travel.example.json"
  },
...
1. `knowledge/product/governance/intent-contract-memory.json`
2. `knowledge/product/governance/intent-contract-selection-policy.json`
3. `knowledge/product/schemas/intent-contract-memory.schema.json`
4. `knowledge/product/schemas/intent-contract-selection-policy.schema.json`
