...
When the change is reasoning-only, record the selected profile and adapter in [`wisdom-policy.json`](/Users/famao/kyberion/knowledge/product/governance/wisdom-policy.json) first, then add code only for genuinely new adapters.
...
- `knowledge/product/governance/model-registry.json`
...
- `knowledge/product/governance/model-adaptation-policy.json`
...
- `knowledge/product/schemas/model-adaptation-plan.schema.json`
