...
- 更新: `knowledge/product/governance/intent-coverage-matrix.json`
...
- 新規: `knowledge/product/governance/intent-actuator-bindings.json`
- 新規: `knowledge/product/schemas/intent-actuator-bindings.schema.json`
