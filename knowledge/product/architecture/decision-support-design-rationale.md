...
| 判断支援要素 | Kyberion 契約 |
|---|---|
| プロトコル | `knowledge/product/orchestration/*-protocol.md` |
...
- [docs/archive/CONCEPT_INTEGRATION_BACKLOG.md](docs/archive/CONCEPT_INTEGRATION_BACKLOG.md) — タスク管理（アーカイブ済 / 残作業は `docs/PRODUCTIZATION_ROADMAP.md`）
- [knowledge/product/orchestration/](knowledge/product/orchestration) — プロトコル群
- [knowledge/product/architecture/cli-harness-coordination-model.md](knowledge/product/architecture/cli-harness-coordination-model.md) — 可換層の責務分割
- [knowledge/product/architecture/hardening-backlog.md](knowledge/product/architecture/hardening-backlog.md) — 細部担保計画
