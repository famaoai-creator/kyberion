...
- ルーティングは `knowledge/product/governance` の契約で制御
- 最終的な実行可否は既存の tier/policy/authority が決定

## 追加した契約
- `knowledge/product/schemas/tool-actuator-routing-policy.schema.json`
- `knowledge/product/governance/tool-actuator-routing-policy.json`
