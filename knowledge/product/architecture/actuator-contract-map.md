...
| `browser-actuator`          | pipeline + computer interaction           | `pipeline`, `computer_interaction`                                             | `knowledge/product/schemas/browser-automation-pipeline.schema.json`, `schemas/computer-interaction.schema.json` | Browser executor for ref/snapshot interaction loops                                                                                      |
