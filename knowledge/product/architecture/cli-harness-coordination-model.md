...
Reasoning-specific routing should use the policy surface in [`wisdom-policy.json`](/Users/famao/kyberion/knowledge/product/governance/wisdom-policy.json).
...
- `knowledge/product/schemas/harness-adapter-profile.schema.json`
...
- `knowledge/product/schemas/integration-decision.schema.json`
