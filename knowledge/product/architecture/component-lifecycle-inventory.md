...
- `voice-actuator`: Governed local voice generation actuator with native playback and artifact fallback (12 ops, v1.7.0, schema knowledge/product/schemas/voice-action.schema.json)
