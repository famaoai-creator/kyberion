...
- `system-actuator`: OS-level control plane for diagnostics, input toggles, and short-lived OS actions (23 ops, v1.2.0, schema schemas/system-pipeline.schema.json)
