...
- `system-actuator`: OS-level control plane for diagnostics, input toggles, and short-lived OS actions (26 ops, v1.6.0, schema knowledge/product/schemas/system-pipeline.schema.json)
