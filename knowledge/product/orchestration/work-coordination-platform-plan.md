...
- `knowledge/product/schemas/work-item.schema.json`
- `knowledge/product/schemas/work-board.schema.json`
- `knowledge/product/schemas/work-lease.schema.json`
- `knowledge/product/schemas/work-coordination-event.schema.json`
...
- `knowledge/product/orchestration/work-coordination-platform.md`
- `knowledge/product/orchestration/work-coordination-examples/project-board.json`
- `knowledge/product/orchestration/work-coordination-examples/personal-todo.json`
