...
- catalog id: `default`
- overlay file: `knowledge/product/governance/organization-team-template-catalogs/default.json`
- behavior: no overlay entries, so the base mission team templates are used as-is

### `demo-org`

- catalog id: `demo-org`
- overlay file: `knowledge/product/governance/organization-team-template-catalogs/demo-org.json`
...
- catalog id: `ops-org`
- overlay file: `knowledge/product/governance/organization-team-template-catalogs/ops-org.json`
