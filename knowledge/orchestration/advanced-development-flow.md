...
- **`browser-navigator` & `synthetic-user-persona`**: 仮想人格による自律的E2Eテスト。
- **`security-scanner` & `license-auditor`**: セキュリティと法的リスクの最終スキャン。
- **`cognitive-load-auditor`**: コードとUIの複雑度を監査し、保守性を保証。
