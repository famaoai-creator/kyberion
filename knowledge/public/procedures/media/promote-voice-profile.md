...
- `confidential` and `public` profiles continue to use `knowledge/product/governance/voice-profile-registry.json`
- the public registry also maintains `knowledge/product/governance/voice-profiles/*.json` as the canonical directory
