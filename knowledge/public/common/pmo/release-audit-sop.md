...
_Version: 1.3.0 (Execution Steps & Jira Evidence Added)_
_Category: PMO / Governance_
...
- **実行コマンド**:
  ```bash
  pnpm run kyberion -- run service-actuator -- --service jira --action get-issue --issue-key=<JIRA_ID>
  ```
