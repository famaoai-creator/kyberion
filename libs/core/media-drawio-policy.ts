...
const CATALOG_PATH = pathResolver.knowledge('public/governance/media-drawio-policy.json');
const SCHEMA_PATH = pathResolver.knowledge('public/schemas/media-drawio-policy.schema.json');
