...
function footer(pageNum: number): PptxElement[] {
  return [
    ...
    txt(
      'Devin 評価プロジェクト計画書',
      { x: 0.4, y: 7.1, w: 5, h: 0.3 },
      { fontSize: 8, color: C.gray400 }
    ),
    txt(
      `Confidential  |  ${pageNum}`,
      { x: 7, y: 7.1, w: 2.6, h: 0.3 },
...
const slide2: PptxSlide = {
  ...
  elements: [
    ...
    // Box 1: Quality
    shape('roundRect', { x: 0.5, y: 5.0, w: 2.7, h: 1.6 }, '', {
      fill: C.blueLight,
      line: C.blue,
      lineWidth: 1,
    }),
    txt(
      '品質',
      { x: 0.5, y: 5.1, w: 2.7, h: 0.4 },
      { fontSize: 16, bold: true, color: C.navy, align: 'center' }
    ),
    txt(
      'コード品質\nバグ発生率\nベストプラクティス準拠',
      { x: 0.7, y: 5.5, w: 2.3, h: 1.0 },
      { fontSize: 11, color: C.gray700, align: 'center' }
    ),
    // Box 2: Speed
    shape('roundRect', { x: 3.65, y: 5.0, w: 2.7, h: 1.6 }, '', {
      fill: C.greenLight,
      line: C.green,
      lineWidth: 1,
    }),
    txt(
      '速度',
      { x: 3.65, y: 5.1, w: 2.7, h: 0.4 },
      { fontSize: 16, bold: true, color: C.green, align: 'center' }
    ),
    txt(
      '開発速度\nタスク完了時間\n人手との比較',
      { x: 3.85, y: 5.5, w: 2.3, h: 1.0 },
      { fontSize: 11, color: C.gray700, align: 'center' }
    ),
    // Box 3: Cost
    shape('roundRect', { x: 6.8, y: 5.0, w: 2.7, h: 1.6 }, '', {
      fill: C.orangeLight,
      line: C.orange,
      lineWidth: 1,
    }),
...
const slide4: PptxSlide = {
  ...
  elements: [
    ...
    txt(
      'W1: 3/16-20',
      { x: 0.5, y: 1.7, w: 2.1, h: 0.3 },
      { fontSize: 11, bold: true, color: C.gray600, align: 'center' }
    ),
    txt(
      'W2: 3/23-27',
      { x: 2.75, y: 1.7, w: 2.1, h: 0.3 },
      { fontSize: 11, bold: true, color: C.gray600, align: 'center' }
    ),
    txt(
      'W3: 3/30-4/3',
      { x: 5.0, y: 1.7, w: 2.1, h: 0.3 },
      { fontSize: 11, bold: true, color: C.gray600, align: 'center' }
    ),
    txt(
      'W4: 4/6-10',
      { x: 7.25, y: 1.7, w: 2.25, h: 0.3 },
      { fontSize: 11, bold: true, color: C.gray600, align: 'center' }
    ),
    // Timeline bars
    // Phase 1: 計画・準備 (W1)
...
const slide5: PptxSlide = {
  ...
  elements: [
    ...
    // PJ1
    shape('roundRect', { x: 0.5, y: 1.3, w: 2.8, h: 5.5 }, '', {
      fill: C.gray50,
      line: C.green,
      lineWidth: 2,
    }),
    ...
    txt(
      '期間: 3/23 - 3/27',
      { x: 0.7, y: 5.1, w: 2.4, h: 0.3 },
      { fontSize: 10, color: C.gray600 }
    ),
    // PJ2
    shape('roundRect', { x: 3.6, y: 1.3, w: 2.8, h: 5.5 }, '', {
      fill: C.gray50,
      line: C.blue,
      lineWidth: 2,
    }),
    ...
    // PJ3
    shape('roundRect', { x: 6.7, y: 1.3, w: 2.8, h: 5.5 }, '', {
      fill: C.gray50,
      line: C.orange,
      lineWidth: 2,
    }),
...
const slide6: PptxSlide = {
  ...
  elements: [
    ...
    // Notes
    txt(
      '※ 各PJで上記プロセスを実施し、最終的に3PJ分の結果を統合して総合評価を行う',
      {
        x: 0.5,
        y: 6.2,
        w: 9,
...
const slide7: PptxSlide = {
  ...
  elements: [
    ...
    txt(
      'リスクマップ',
      { x: 0.5, y: 5.2, w: 4, h: 0.4 },
      { fontSize: 16, bold: true, color: C.navy }
    ),
    // Y-axis label
    txt(
      '影\n響\n度',
      { x: 0.3, y: 5.7, w: 0.35, h: 1.5 },
      { fontSize: 10, bold: true, color: C.gray600, align: 'center' }
    ),
    // Grid
    shape('rect', { x: 0.7, y: 5.7, w: 1.5, h: 0.75 }, '', {
      fill: C.orangeLight,
      line: C.gray200,
      lineWidth: 0.5,
    }),
    shape('rect', { x: 2.2, y: 5.7, w: 1.5, h: 0.75 }, '', {
      fill: C.redLight,
      line: C.gray200,
      lineWidth: 0.5,
    }),
    shape('rect', { x: 0.7, y: 6.45, w: 1.5, h: 0.5 }, '', {
      fill: C.greenLight,
      line: C.gray200,
      lineWidth: 0.5,
    }),
    shape('rect', { x: 2.2, y: 6.45, w: 1.5, h: 0.5 }, '', {
      fill: C.orangeLight,
      line: C.gray200,
      lineWidth: 0.5,
    }),
    ...
    txt(
      '低',
      { x: 0.7, y: 6.95, w: 1.5, h: 0.25 },
      { fontSize: 9, color: C.gray600, align: 'center' }
    ),
    txt(
      '高',
      { x: 2.2, y: 6.95, w: 1.5, h: 0.25 },
      { fontSize: 9, color: C.gray600, align: 'center' }
    ),
    txt(
      '発生確率',
      { x: 1.2, y: 7.15, w: 1.5, h: 0.25 },
      { fontSize: 9, bold: true, color: C.gray600, align: 'center' }
    ),
    // Risk dots
    txt(
      'R1',
      { x: 2.6, y: 5.85, w: 0.5, h: 0.4 },
      { fontSize: 11, bold: true, color: C.red, align: 'center' }
    ),
    txt(
      'R2',
      { x: 2.3, y: 6.5, w: 0.5, h: 0.35 },
      { fontSize: 11, bold: true, color: C.orange, align: 'center' }
    ),
    txt(
      'R3',
      { x: 0.9, y: 6.5, w: 0.5, h: 0.35 },
      { fontSize: 11, bold: true, color: C.green, align: 'center' }
    ),
    txt(
      'R4 R5',
      { x: 0.85, y: 5.9, w: 0.9, h: 0.35 },
      { fontSize: 11, bold: true, color: C.orange, align: 'center' }
    ),
...
const slide8: PptxSlide = {
  ...
  elements: [
    ...
    // Checklist items
    shape('roundRect', { x: 0.5, y: 4.5, w: 4.2, h: 2.3 }, '', {
      fill: C.blueLight,
      line: C.blue,
      lineWidth: 1,
    }),
    ...
    shape('roundRect', { x: 5.3, y: 4.5, w: 4.2, h: 2.3 }, '', {
      fill: C.greenLight,
      line: C.green,
      lineWidth: 1,
    }),
...
// ─── Generate ───────────────────────────────────────────────
const outputPath = pathResolver.sharedTmp('native-pptx/Devin評価PJ_計画書.pptx');

async function main() {
  safeMkdir(pathResolver.sharedTmp('native-pptx'), { recursive: true });
