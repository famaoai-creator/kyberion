...
const CATALOG_PATH = pathResolver.knowledge('public/governance/media-drawio-tier-order.json');
const SCHEMA_PATH = pathResolver.knowledge('public/schemas/media-drawio-tier-order.schema.json');
