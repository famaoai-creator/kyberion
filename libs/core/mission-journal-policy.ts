...
const CATALOG_PATH = pathResolver.knowledge('public/governance/mission-journal-policy.json');
const SCHEMA_PATH = pathResolver.knowledge('public/schemas/mission-journal-policy.schema.json');
