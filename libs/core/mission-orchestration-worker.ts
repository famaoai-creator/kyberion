...
const taskResultResponseDeps: TaskResultResponseDeps = {
  recordMissionVisiblePrompt,
...
async function obtainTaskResultResponse(
...
const dispatchCoreDeps: DispatchCoreDeps = {
...
const missionLifecycleHandlerDeps: MissionLifecycleHandlerDeps = {
  runMissionController,
  emitSlackMissionEvent,
  resolveMissionType,
