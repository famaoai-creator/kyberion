/* eslint-disable no-restricted-imports -- IP-08 で managed-process/safeExec 経由へ移行予定 (docs/developer/improvement-plans-2026-07/IP-08_ERROR_HANDLING_DISCIPLINE.ja.md) */
