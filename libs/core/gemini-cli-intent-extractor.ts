...
export interface GeminiCliIntentExtractorOptions extends GeminiCliBackendOptions {}

export class GeminiCliIntentExtractor implements IntentExtractor {
  readonly name = 'gemini-cli';
  private readonly options: GeminiCliBackendOptions;

  constructor(options: GeminiCliIntentExtractorOptions = {}) {
  ...
  async extract(input: ExtractIntentInput): Promise<IntentBody> {
    ...
    const parsed = (await runGeminiCliQuery({
