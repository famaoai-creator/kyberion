...
export const KB_UI_DEFAULT_MESSAGES = Object.freeze({
  ...
  'ui:drawing_clear': 'Clear',
  'ui:drawing_color': 'Color {color}',
  'ui:drawing_colors': 'Colors',
  'ui:drawing_custom_color': 'Custom color',
  'ui:drawing_tool_arrow': 'Arrow',
  'ui:drawing_tool_ellipse': 'Ellipse',
  'ui:drawing_tool_eraser': 'Eraser',
  'ui:drawing_tool_highlighter': 'Highlighter',
  'ui:drawing_tool_line': 'Line',
  'ui:drawing_tool_pen': 'Pen',
  'ui:drawing_tool_rect': 'Rectangle',
  'ui:drawing_tool_text': 'Text',
  'ui:drawing_tools': 'Drawing tools',
  'ui:drawing_undo': 'Undo',
  'ui:drawing_width': 'Width',
  'ui:drawing_width_value': '{width} px',
  ...
  'ui:sketch_background_added': 'Background image added.',
  'ui:sketch_background_rejected': '{file} is not an image.',
  'ui:sketch_canvas': '{label}: drawing canvas',
  'ui:sketch_clear_confirm': 'Clear drawing',
  'ui:sketch_clear_message': 'Everything you drew is removed. The background image stays.',
  'ui:sketch_clear_title': 'Clear the drawing?',
  'ui:sketch_download': 'Download PNG',
  'ui:sketch_drop_hint': 'Drop or paste an image to use it as the background.',
  'ui:sketch_text_input': 'Text to place on the canvas',
  ...
  'ui:value_no': 'No',
  'ui:value_yes': 'Yes',
  'ui:voice_input_dictate': 'Dictate',
  'ui:voice_input_error_aborted': 'Voice input was interrupted.',
  'ui:voice_input_error_network': 'Voice recognition needs a network connection.',
  'ui:voice_input_error_no_speech': 'No speech was heard. Try again.',
  'ui:voice_input_error_permission_denied': 'Microphone access was blocked.',
  'ui:voice_input_error_unknown': 'Voice input stopped because of an error.',
  'ui:voice_input_hold': 'Hold to talk',
  'ui:voice_input_hold_hint': 'Hold the button, or hold Space, while you talk.',
  'ui:voice_input_listening': 'Listening…',
  'ui:voice_input_processing': 'Finishing…',
  'ui:voice_input_record': 'Record',
  'ui:voice_input_recording': 'Recording…',
  'ui:voice_input_requesting': 'Waiting for microphone access…',
  'ui:voice_input_stopped': 'Stopped',
  'ui:voice_input_transcribing': 'Transcribing…',
  'ui:voice_input_unsupported_dictation': "Voice input isn't available in this browser.",
  'ui:voice_input_unsupported_record': "Recording isn't available in this browser.",
  'ui:voice_state_error': 'Something went wrong',
  'ui:voice_state_idle': 'Idle',
  'ui:voice_state_listening': 'Listening',
  'ui:voice_state_muted': 'Muted',
  'ui:voice_state_speaking': 'Speaking',
  'ui:voice_state_thinking': 'Thinking',
});
