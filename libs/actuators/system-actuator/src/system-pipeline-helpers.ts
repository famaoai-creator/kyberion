...
import {
  ALLOW_UNSAFE_SHELL,
  ALLOW_UNSAFE_JS,
  COMPUTER_RUNTIME_DIR,
  SYSTEM_MANIFEST_PATH,
  DEFAULT_SYSTEM_RETRY,
  writeRedactedScreenFrames,
  warnedSystemOpAliases,
  ...
  opControl,
  opCapture,
  resolveCanonicalScreenRecordingPath,
  resolveCanonicalScreenCapturePath,
