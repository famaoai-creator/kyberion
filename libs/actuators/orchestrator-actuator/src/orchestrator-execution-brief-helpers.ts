...
export function normalizeRequestTextForArchetypeDetection(requestText: string): string {
...
export function isMeaningfulInputValue(value: unknown): boolean {
...
export function resolveExecutionBriefReference(ctx: any, explicitKey?: string): unknown {
...
export function buildPipelineBundleJobs(archetypeId: string): PipelineBundleJob[] {
  switch (archetypeId) {
    case 'status-inquiry':
      return [
        {
...
export function repairRenderedPipelineContract(renderedPipeline: Record<string, unknown>): {
...
export function collectCommandHealth(command: string, args: string[]) {
  try {
...
export function deriveExecutionBriefReadiness(missingInputs: string[], requestText: string) {
...
export function collectMissionStatusSnapshot(targetId?: string) {
...
export function resolveActuatorEntryPath(actuator: string): string {
...
export function renderTemplateValue(value: unknown, variables: Record<string, unknown>): unknown {
...
export function renderTemplateString(input: string, variables: Record<string, unknown>): string {
...
export function setByPath(target: Record<string, unknown>, overridePath: string, value: unknown) {
